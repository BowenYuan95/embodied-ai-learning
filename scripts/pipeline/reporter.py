...
def generate_report(
    ...
    print_action_statistics(
        actions
    )

    print_action_range_check(
        actions
    )

    print_action_smoothness(
        actions
    )
...
def plot_all_action_dimensions(actions):
